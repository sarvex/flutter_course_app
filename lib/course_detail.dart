                  ...
                  child: SingleChildScrollView(
                    child: Container(
                      constraints: BoxConstraints(
                          minHeight: infoHeight, maxHeight: tempHight > infoHeight ? tempHight : infoHeight),
                      child: Column(
                                  ...
                                  Container(
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                        ...
                                        border: new Border.all(color: AppTheme.grey.withOpacity(0.2)),
                                      ),
                                      child: Icon(
                                        Icons.add,
                                        color: AppTheme.nearlyBlue,
    ...
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: <BoxShadow>[
            BoxShadow(color: AppTheme.grey.withOpacity(0.2), offset: Offset(1.1, 1.1), blurRadius: 8.0),
          ],
        ),
        child: Padding(
